...
|——img
|————bg.jpg
|——index.html</code></pre><p>那么index.html该如何引用img文件夹下的bg.jpg呢？它可以这么写“img/bg.jpg”或“./img/bg.jpg”。</p><p>好了，路径就讲完了，如果还不懂，就自己试一试，实践出真知。</p></div>`,
    date: [2022, 7, 11],
    tag: ['HTML/CSS'],
